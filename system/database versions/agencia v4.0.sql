...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-09-2020 a las 22:56:20
...
INSERT INTO `pregunta` (`id_pregunta`, `pregunta`, `opcion_respuesta`, `id_rama`) VALUES
(2, 'que estudias has hecho', 'abierta', 1);
...
INSERT INTO `ramas` (`id_rama`, `nombre_rama`, `numero_rama`) VALUES
(1, 'Estudios Realizados', 4);
...
--
ALTER TABLE `ramas`
  MODIFY `id_rama` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `formulario_migratorio`
  ...
  ADD CONSTRAINT `formulario_migratorio_ibfk_2` FOREIGN KEY (`id_pregunta`) REFERENCES `pregunta` (`id_pregunta`);
