...
-- -----------------------------------------------------
-- Table `agencia`.`tours_paquete`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`tours_paquete` (
  `id_tours` INT NULL ,
  ...
  `urlQrCodeEnlace` VARCHAR(120) NULL ,
  `urlEnlace` VARCHAR(30) NULL ,
...
CREATE  TABLE IF NOT EXISTS `agencia`.`marca_vehiculo` (
  `id_marca` INT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `agencia`.`rentaCar`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`rentaCar` (
  `id_rentaCar` INT NULL AUTO_INCREMENT ,
  `nombre` VARCHAR(45) NULL ,
  `lugar` VARCHAR(45) NULL ,
  `descripcion` VARCHAR(45) NULL ,
  `usuario` VARCHAR(45) NULL ,
  `contrasena` VARCHAR(45) NULL ,
  PRIMARY KEY (`id_rentaCar`) )
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `agencia`.`transmisionVehiculo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`transmisionVehiculo` (
  `idtransmicion` INT NULL AUTO_INCREMENT ,
  `transmision` VARCHAR(45) NULL ,
  PRIMARY KEY (`idtransmicion`) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `agencia`.`vehiculo` (
  ...
  `id_rentaCarFK` INT NOT NULL ,
  `id_marcaFK` INT NOT NULL ,
  `id_transmicionFK` INT NOT NULL ,
  `placa` VARCHAR(45) NULL ,
  `anio` INT NULL ,
  `puertas` INT NULL ,
  `pasajeros` INT NULL ,
  `precio_diario` FLOAT NULL ,
  `servicios_adicionales` VARCHAR(100) NULL ,
  `seguros` VARCHAR(200) NULL ,
  `descripcion` VARCHAR(200) NULL ,
  PRIMARY KEY (`idvehiculo`) ,
  INDEX `fk_vehiculo_marca_vehiculo1_idx` (`id_marcaFK` ASC) ,
  INDEX `fk_vehiculo_agencia1_idx` (`id_rentaCarFK` ASC) ,
  INDEX `fk_vehiculo_transmicion1_idx` (`id_transmicionFK` ASC) ,
  CONSTRAINT `fk_vehiculo_marca_vehiculo1`
    FOREIGN KEY (`id_marcaFK` )
    REFERENCES `agencia`.`marca_vehiculo` (`id_marca` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vehiculo_agencia1`
    FOREIGN KEY (`id_rentaCarFK` )
    REFERENCES `agencia`.`rentaCar` (`id_rentaCar` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vehiculo_transmicion1`
    FOREIGN KEY (`id_transmicionFK` )
    REFERENCES `agencia`.`transmisionVehiculo` (`idtransmicion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `agencia`.`reserva` (
  ...
  CONSTRAINT `fk_reservaTours_tours1`
    ...
    REFERENCES `agencia`.`tours_paquete` (`id_tours` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE  TABLE IF NOT EXISTS `agencia`.`mantenimiento` (
  `id_mantenimiento` INT NULL AUTO_INCREMENT ,
  ...
  INDEX `fk_mantenimiento_vehiculo1_idx` (`id_vehiculoFK` ASC) ,
  CONSTRAINT `fk_mantenimiento_vehiculo1`
    FOREIGN KEY (`id_vehiculoFK` )
    REFERENCES `agencia`.`vehiculo` (`idvehiculo` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `agencia`.`ramas_preguntas`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`ramas_preguntas` (
  `id_rama` INT NOT NULL ,
  `categoria_rama` VARCHAR(255) NULL ,
  `num_rama` INT NULL ,
  PRIMARY KEY (`id_rama`) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `agencia`.`pregunta` (
  ...
  `opcion` ENUM('abierta','cerrada') NULL ,
  `id_rama` INT NOT NULL ,
  PRIMARY KEY (`id_pregunta`) ,
  INDEX `fk_pregunta_ramas_preguntas1_idx` (`id_rama` ASC) ,
  CONSTRAINT `fk_pregunta_ramas_preguntas1`
    FOREIGN KEY (`id_rama` )
    REFERENCES `agencia`.`ramas_preguntas` (`id_rama` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `agencia`.`formulario_migratorio` (
  ...
  PRIMARY KEY (`id_formulario`) ,
  INDEX `fk_formulario_migratorio_asosoria1_idx` (`id_asesoria` ASC) ,
  CONSTRAINT `fk_formulario_migratorio_pregunta1`
    FOREIGN KEY (`id_pregunta` )
    REFERENCES `agencia`.`pregunta` (`id_pregunta` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_formulario_migratorio_asosoria1`
    FOREIGN KEY (`id_asesoria` )
    REFERENCES `agencia`.`asosoria` (`id_asosoria` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `agencia`.`galeria`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`galeria` (
...
-- -----------------------------------------------------
-- Table `agencia`.`galeria_vehiculo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`galeria_vehiculo` (
  `idgaleria_vehiculo` INT NULL AUTO_INCREMENT ,
  `tipo` VARCHAR(45) NULL ,
  `foto_path` VARCHAR(100) NULL ,
  `principal` TINYINT(1) NULL ,
  `identificador` INT NULL ,
  PRIMARY KEY (`idgaleria_vehiculo`) ,
  INDEX `fk_galeria_vehiculo_vehiculo1_idx` (`identificador` ASC) ,
  CONSTRAINT `fk_galeria_vehiculo_vehiculo1`
...
-- -----------------------------------------------------
-- Table `agencia`.`modelo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `agencia`.`modelo` (
  `idmodelo` INT NULL AUTO_INCREMENT ,
  `id_marca` INT NOT NULL ,
  `modelo` VARCHAR(45) NULL ,
  PRIMARY KEY (`idmodelo`) ,
  INDEX `fk_modelo_marca_vehiculo1_idx` (`id_marca` ASC) ,
  CONSTRAINT `fk_modelo_marca_vehiculo1`
