...
$config = array(
	...
	'insertarSitio' => array(
		...
		// array('field' => 'longitud'            , 'label' => 'longiitud'              , 'rulews' => 'trim|required|min_length[3]'),
	...
	'editarTurPaquete' => array(
		array('field' => 'id_tours'         ,'label' => 'ID TUR'              , 'rules' => 'trim'),
		array('field' => 'nombreTours'      ,'label' => 'Nombre del Viaje'    , 'rules' => 'trim'),
		array('field' => 'start'            ,'label' => 'Fecha de Salida'     , 'rules' => 'trim'),
		array('field' => 'descripcion_tur'  ,'label' => 'Descripcion'         , 'rules' => 'trim||min_length[3]'),
		array('field' => 'tipo'             ,'label' => 'Tipo'                , 'rules' => 'trim'),
		array('field' => 'cupos_disponibles','label' => 'Cupos de Paquetes'   , 'rules' => 'trim||integer'),
		array('field' => 'precio'           ,'label' => 'Precio'              , 'rules' => 'trim||numeric'),
		array('field' => 'lugar_salida'     ,'label' => 'Lugar de salida'     , 'rules' => 'trim'),
		array('field' => 'no_incluye'       ,'label' => 'No Incluye'          , 'rules' => 'trim'),
		array('field' => 'requisitos'       ,'label' => 'Requisitos'          , 'rules' => 'trim'),
		array('field' => 'promociones'      ,'label' => 'Promociones'         , 'rules' => 'trim'),
		array('field' => 'incluye'          ,'label' => 'Incluye'             , 'rules' => 'trim'),
		// array('field' => 'nombre_encargado' ,'label' => 'Nombre de Encargado' , 'rules' => 'trim|required|min_length[3]|max_length[45]'),
